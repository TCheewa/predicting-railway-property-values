...
for test_town in towns:
    ...
    results.extend([res_lr, res_rf, res_xgb])
...
results_df.to_csv(f"{output_dir}/cross_town_all_models.csv", index=False)

print(f"\n All model results saved to {output_dir}/cross_town_all_models.csv")
